...
from body_shape_estimation.openpose.models.CocoPoseNet import CocoPoseNet, compute_loss
from body_shape_estimation.openpose.entity import params, JointType
        ...
        for i, (limb, color) in enumerate(zip(params['limbs_point'], limb_colors)):
            if i != 9 and i != 13:  # don't show ear-shoulder connection
                ...
                if np.all(pose[limb_ind][:, 2] != 0):
                    ...
                    cv2.line(canvas, tuple(joint1), tuple(joint2), color, 10)
